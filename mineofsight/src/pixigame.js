...
onAssetsLoaded = function (loader,resources) {
	...
	document.body.style.backgroundColor =  "#1F1129";	// the dark colour around the edges, I just think it looks good
...
setup_pixi = function () {
	// create a renderer instance.
		...
		renderer.backgroundColor = 0x1F1129;
