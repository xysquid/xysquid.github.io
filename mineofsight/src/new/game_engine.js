...
BlipFrogMenuClass = Class.extend({
	...
	pop_up: function() {
		...
		this.menu_x = 0;//screen_height;
		this.game_x = 0;

		this.menu_x_target = 200;//screen_height*options_menu_group.scale.y - this.menu_positions.menu_height*options_menu_group.scale.y;
		//*devicePixelRatio;//g_menu_font_height*MenuItems.length;
		this.game_y_target = 200;//-this.menu_positions.menu_height/options_menu_group.scale.y;
		this.moving = 12;
	...
	pop_down: function() {
		...
		this.menu_x = 200;//screen_height - this.menu_positions.menu_height;//*devicePixelRatio;//g_menu_font_height*MenuItems.length;
		this.game_y = 200;//-this.menu_positions.menu_height*1;

		this.game_y_target = 0;
		this.menu_y_target = 0;//screen_height*options_menu_group.scale.y;
		this.moving = 12;
	},
	...
	on_screen_resize: function() {
		...
		for (var i = 0; i < this.sprites_buttons.length; i++) {
			...
			this.menu_texts[i].update_pos(0,y + 42,999,999);
		...
		this.graphics_menu_body.scale(200, 9*this.menu_positions.menu_height/50);
		...
		if (this.menu_up == true) g_set_menu_screen_x(200);//screen_height - g_menu_font_height*MenuItems.length);
		else g_set_menu_screen_y(0);//screen_height);
