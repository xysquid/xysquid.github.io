...
theGame.prototype = {
	...
	on_up: function() {
		...
		if (input_down == true) { // && !this.game.input.isDown ) {
			input_down = false;
			if (this.right_down == true) gBlipFrogMenu.handle_events((game.input.x - x_shift_screen)/ratio, (game.input.y-y_shift_screen)/ratio, Types.Events.MOUSE_CLICK_RIGHT);
			else if (this.left_down == true) {gBlipFrogMenu.handle_events((game.input.x- x_shift_screen)/ratio ,(game.input.y-y_shift_screen)/ratio,Types.Events.MOUSE_UP);
				
			} else gBlipFrogMenu.handle_events((game.input.x- x_shift_screen)/ratio ,(game.input.y-y_shift_screen)/ratio,Types.Events.MOUSE_UP);
	...
	on_down: function() {
		...
		if (game.input.mousePointer.rightButton.isDown ) {
			...
			if (gBlipFrogMenu.menu_up == true) {
				...
				//gBlipFrogMenu.handle_events((game.input.x - x_shift_screen)/ratio, 									//						(game.input.y-y_shift_screen)/ratio, Types.Events.MOUSE_CLICK_RIGHT);
			...
			if (gBlipFrogMenu.menu_up == true) {
				...
				gBlipFrogMenu.handle_events((game.input.x- x_shift_screen)/ratio ,(game.input.y-y_shift_screen)/ratio, Types.Events.MOUSE_DOWN);
