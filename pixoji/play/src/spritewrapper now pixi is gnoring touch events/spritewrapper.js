...
LayerClass = Class.extend({
	...
	init: function() {
		if (using_phaser == true) {
			...
			// 0x1F1129
			// pixi
			this.layer = new PIXI.Container('0x1F1129');	// DisplayObjectContainer();
		}
...
pixi_update_tilegrid = function() {
	...
	//g_pixi_tilegrid_texture.render(static_tile_group.layer);
...
pixi_init_tilegrid = function() {
	...
	// is this reusable?
	g_pixi_tilegrid_texture = PIXI.RenderTexture.create(1000, 1000);
